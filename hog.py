...
def boar_brawl(player_score, opponent_score):
    ...
    """
    player_last_digit = player_score % 10
    if opponent_score < 100:
        opponent_last_digit = opponent_score // 10
    else:
        opponent_last_digit = (opponent_score // 10) % 10
    
    difference = abs(opponent_last_digit - player_last_digit)
...
def fuzzy_points(score):
    ...
    """
    # BEGIN PROBLEM 4
    if hog_gcd(score, 100) > 10 and hog_gcd(score, 100) < 100:
        return score + (2*(hog_gcd(score,100)//10))
    elif hog_gcd(score, 100) > 100:
...
def fuzzy_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    return fuzzy_points(player_score + take_turn(num_rolls, player_score, opponent_score, dice))
    # END PROBLEM 4
...
def fuzzy_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    rolls = 0
    if fuzzy_update(rolls, score, opponent_score) - score >= threshold:
        return 0
    else:
        return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
